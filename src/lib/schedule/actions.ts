...
export async function savePosterSettings(input: PosterSettings): Promise<PosterSettings> {
  const value: PosterSettings = {
    ...
    visitorScale: num(input.visitorScale, DEFAULT_SETTINGS.visitorScale, 0.8, 1.6),
    visitorBold: Boolean(input.visitorBold),
    hostScale: num(input.hostScale, DEFAULT_SETTINGS.hostScale, 0.8, 1.6),
    hostBold: Boolean(input.hostBold),
    roomScale: num(input.roomScale, DEFAULT_SETTINGS.roomScale, 0.8, 1.6),
    roomBold: Boolean(input.roomBold),
